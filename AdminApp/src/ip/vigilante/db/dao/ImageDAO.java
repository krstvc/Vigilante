...
public class ImageDAO {
	 ...
	 * @return			List of all images for a single post matched by the ID from database
	 */
	...
	/**
	 * @param id	Unique ID of an image
	 * @return		Image matched by the ID
	 */
	...
	/**
	 * @param image		New image to be inserted in database
	...
	/**
	 * @param id	Unique ID of an image to be deleted
