...
public class UserDAO {
	 ...
	 * @return			User matched by the username
	 */
	 ...
	 * @return			User matched by the email address
	 */
	...
	/**
	 * @param id	Unique ID
	 * @return		True if the user matched by the ID was deleted successfully, false otherwise
	 */
